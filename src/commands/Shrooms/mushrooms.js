...
module.exports = {
	data: new SlashCommandBuilder().setName('mushrooms').setDescription('Display mushroom info'),
...
const button = new ActionRowBuilder()
  ...
  let g = 0;
  msrms.forEach((row) =>{
    if(row.Show=='Mushroom')msmrsEmb.addFields({name: row.Name , value: row.Desc})
